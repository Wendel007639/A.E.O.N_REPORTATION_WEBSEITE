...
const evidenceRows: EvidenceRow[] = [
  {
    artifact: "intelligence_summary.json",
    exists: false,
    bytes: "offen",
    path: "evidence/latest/intelligence_summary.json",
    note: "Wird in Patch 6/8 mit echtem Lauf verbunden."
  },
  {
    artifact: "intelligence_manifest.json",
    exists: false,
    bytes: "offen",
    path: "evidence/latest/intelligence_manifest.json",
    note: "Manifest fuer reproduzierbare Bewertung."
  },
  {
    artifact: "proof_smoke_summary.json",
    exists: false,
    bytes: "offen",
    path: "evidence/latest/proof_smoke_summary.json",
    note: "Smoke-Auswertung fuer ProofKit."
  },
  {
    artifact: "proof_smoke_raw.json",
    exists: false,
    bytes: "offen",
    path: "evidence/latest/proof_smoke_raw.json",
    note: "Rohdaten fuer Nachvollziehbarkeit."
  },
  {
    artifact: "proof_gate_status.env",
    exists: false,
    bytes: "offen",
    path: "evidence/latest/proof_gate_status.env",
    note: "Gate-Status, besonders FAILED_GATES."
  },
  {
    artifact: "evidence_brief.md",
    exists: false,
    bytes: "offen",
    path: "evidence/latest/evidence_brief.md",
    note: "Menschlich lesbare Kurzreportation."
  }
];
